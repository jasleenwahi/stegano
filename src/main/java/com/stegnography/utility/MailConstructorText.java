...
@Component
public class MailConstructorText {
	@Autowired
	...
	public MimeMessagePreparator constructOrderConfirmationEmail(String link, String email1) {
		...
		MimeMessagePreparator messagePreparator = new MimeMessagePreparator() {
			...
			public void prepare(MimeMessage mimeMessage) throws Exception {
				...
				email.setFrom(String.valueOf(new InternetAddress("mehakknol@gmail.com")));
			}
		};
	...
	public MimeMessagePreparator constructOrderConfirmationEmail1(String username, String password, String email1) {
		...
		MimeMessagePreparator messagePreparator = new MimeMessagePreparator() {
			...
			public void prepare(MimeMessage mimeMessage) throws Exception {
				MimeMessageHelper email = new MimeMessageHelper(mimeMessage);
				email.setTo(email1);
				email.setSubject("your encrypted audio username and password");
				email.setText(text, true);
				email.setFrom(String.valueOf(new InternetAddress("mehakknol@gmail.com")));
			}
		};
